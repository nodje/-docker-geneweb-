...
RUN apt update && apt upgrade -y && apt install -qy gcc make software-properties-common && add-apt-repository ppa:avsm/ppa && apt update && apt install -qy opam libstring-shellquote-perl
